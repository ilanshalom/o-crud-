...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`escola` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
('12345-3','Luiz Peres',21,'M',2,'ADS'),
('12345-4','Pedro Alves',45,'M',2,'ADS'),
('12345-5','Jorge Lopes',26,'M',2,'TSI'),
('12345-6','Bruno Cenati',25,'M',4,'TSI'),
('12345-7','Leila Souza',21,'F',4,'ADS'),
...
('ADS','CST em Análise e Desenvolvimento de Sistemas'),
('ARQ','Arquitetura'),
('CC','Ciências Contáveis'),
...
('GEO','Geofrafia'),
('LET','Letras'),
('RC','CST em Redes de Computadores'),
('SI','CST em Sistemas para Internet');
